...
Usage: I used AI to help structure this GitHub repository and to assist in debugging the training CNN model in Question 3. 
Review: I have manually verified all code and logic to ensure accuracy and compliance with the project requirements.
